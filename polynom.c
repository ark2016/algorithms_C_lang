/*//==============================================================================================================
Составьте программу polynom.c, вычисляющую значение полинома и его производной в заданной точке. Коэффициенты 
полинома и значение  — целые числа в диапазоне от -2^63 до 2^63 - 1.
Программа должна считывать из стандартного потока ввода степень полинома, значение  и коэффициенты полинома.
В стандартный поток вывода нужно вывести значения P_n(x_0) и P_n'(x_0).
